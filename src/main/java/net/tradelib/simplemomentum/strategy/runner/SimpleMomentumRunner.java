package net.tradelib.simplemomentum.strategy.runner;
...
import net.tradelib.simplemomentum.strategy.SimpleMomentum;
 ...
 */
@Component
public class SimpleMomentumRunner implements CommandLineRunner {
        ...
        if(Boolean.parseBoolean(env.getProperty("write.report", "false"))) {
            ...
            if(emailEnabled) {
                ...
                try {
                    ...
                    msg.addRecipients(MimeMessage.RecipientType.TO, emailRecipients);
